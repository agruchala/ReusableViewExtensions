...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ReusableViewExtensions.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Artur Gruchała/ReusableViewExtensions'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Artur Gruchała' => 'gruchala.a@gmail.com' }
  s.source           = { :git => 'https://github.com/Artur Gruchała/ReusableViewExtensions.git', :tag => s.version.to_s }
